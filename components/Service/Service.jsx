      ...
      <section className="bg-white py-12 sm:py-16 lg:py-20">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-lg">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-gray-700 sm:mt-8">
              How do we do it?
            </p>
          </div>

          <div className="sm:col-gap-12 row-gap-12 md:ga mt-10 grid grid-cols-1 sm:mt-16 sm:grid-cols-2 md:grid-cols-3 xl:mt-24">
            ...
            <div className="md:border-b-2 border-sky-500 md:shadow-lg m-2 md:p-8 lg:p-12">
              ...
              <h3 className="mt-12 text-xl font-bold text-slate-800">Trends</h3>
              <p className="mt-5 text-base text-gray-700">

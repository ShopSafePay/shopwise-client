          ...
          <div class="mb-16 text-center lg:mb-0 lg:max-w-lg lg:text-left">
            <div class="mb-6 max-w-xl">
              ...
              <h2 class="mb-6 max-w-lg font-sans text-3xl font-bold tracking-tight text-slate-700 sm:text-5xl sm:leading-snug">
                ...
                in <></>
                <span class="inline-block text-green-500"> The Internet</span>
              </h2>
              <p class="text-base text-gray-700 md:text-lg">
                Delivering Happiness, One Package at a Time. <br />
                We go the extra mile to provide exceptional customer service,
                prompt order processing, and reliable shipping, so that you can
              ...
              <defs>
                <pattern id="img1" x="0" y="0" width="1" height="1">
                  <image
                    ...
                    href="/assets/images/tech_products.jpg"
                  />
                </pattern>
              </defs>

      ...
      <div className="flex w-full flex-wrap">
        <div className="flex w-full flex-col md:w-1/2 lg:w-1/3">
          ...
          <div className="my-auto flex flex-col justify-center px-6 pt-8 sm:px-24 md:justify-start md:px-8 md:pt-0 lg:px-12">
            ...
            <p className="mt-2 text-center">Please Register</p>
            <form className="flex flex-col pt-3 md:pt-8" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full rounded-lg bg-emerald-600 px-4 py-2 text-center text-base font-semibold text-white shadow-md transition ease-in hover:bg-emerald-800 focus:outline-none focus:ring-2"
              >
        ...
        <div className="pointer-events-none hidden select-none bg-black shadow-2xl md:block md:w-1/2 lg:w-2/3">
          ...
          {/* <div className="h-screen w-full object-cover"></div> */}
          //end of carousel
        </div>
      </div>
    </div>
